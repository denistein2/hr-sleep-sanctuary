...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    height: null,
    technologies: [],
    fabric: "Estrutura em MDF ou Estofada",
    warranty: WARRANTY_RELAX,
    durability: null,
    description: "Design arrojado com recuo na base que cria uma ilusão de flutuação, trazendo leveza visual e extrema elegância para o ambiente.",
    officialUrl: "https://eko7.com.br",
    videoId: null,
    categoryId: "box",
    hidden: true,
